...
import { searchManagerApi, deleteManagerApi } from '/@/api/manager';
import { NewsSearchItem } from '/@/api/manager/newsModel';

import { useModal } from '/@/components/Modal';
import { useMessage } from '/@/hooks/web/useMessage';
import ManagerModal from './ManagerModal.vue';

import { columns, getFormConfig } from './manager.data';

export default defineComponent({
  name: 'manager-management',
  components: { BasicTable, ManagerModal, TableAction, Icon, TableImg },
  setup() {
    ...
    async function handleDelete(record: Recordable) {
      await deleteManagerApi({ id: record.id });
